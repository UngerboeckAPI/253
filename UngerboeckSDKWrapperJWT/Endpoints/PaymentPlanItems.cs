...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class PaymentPlanItems : Base<PaymentPlanItemsModel>
  {
    protected internal PaymentPlanItems(ApiClient api) : base(api) { }
    ...
    public PaymentPlanItemsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.PaymentPlanItems options = null)
    {
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<PaymentPlanItemsModel> Search(string searchOData, Search options = null)
    {
