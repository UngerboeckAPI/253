...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BookingRoleOsbConfigurations : Base<BookingRoleOsbConfigurationsModel>
  {
    public BookingRoleOsbConfigurations(ApiClient api) : base(api)
    {
    }
    /// <summary>
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<BookingRoleOsbConfigurationsModel> Search(string searchOData, Search options = null)
    {
    ...
    public BookingRoleOsbConfigurationsModel Get( int Id, Ungerboeck.Api.Models.Options.Subjects.BookingRoleOsbConfigurations options = null)
    {
    ...
    public BookingRoleOsbConfigurationsModel Add(BookingRoleOsbConfigurationsModel model, Ungerboeck.Api.Models.Options.Subjects.BookingRoleOsbConfigurations options = null)
    {
    ...
    public HttpResponseMessage Delete(int Id, Ungerboeck.Api.Models.Options.Subjects.BookingRoleOsbConfigurations options = null)
    {
