...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class RoomFlowInventories : Base<RoomFlowInventoriesModel>
  {
    public RoomFlowInventories(ApiClient api) : base(api)
    {
    }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<RoomFlowInventoriesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public RoomFlowInventoriesModel Get(string orgCode, int flowSequenceNumber, Ungerboeck.Api.Models.Options.Subjects.RoomFlowInventories options = null)
    {
      return base.Get(new { orgCode, flowSequenceNumber }, options);
    }
    ...
    public RoomFlowInventoriesModel Add(RoomFlowInventoriesModel model, Ungerboeck.Api.Models.Options.Subjects.RoomFlowInventories options = null)
    {
    ...
    public RoomFlowInventoriesModel Update(RoomFlowInventoriesModel model, Ungerboeck.Api.Models.Options.Subjects.RoomFlowInventories options = null)
    {
      return base.Update(new { model.OrganizationCode, model.FlowSequenceNumber }, model, options);
    }
