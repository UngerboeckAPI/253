...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class BookingRoleAccounts : Base<BookingRoleAccountsModel>
  {
    protected internal BookingRoleAccounts(ApiClient api) : base(api) { }
    ...
    public SearchResponse<BookingRoleAccountsModel> Search(string searchOData, Search options = null)
    {
    ...
    public BookingRoleAccountsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.BookingRoleAccounts options = null)
    {
    ...
    public BookingRoleAccountsModel Add(BookingRoleAccountsModel model, Ungerboeck.Api.Models.Options.Subjects.BookingRoleAccounts options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.BookingRoleAccounts options = null)
    {
