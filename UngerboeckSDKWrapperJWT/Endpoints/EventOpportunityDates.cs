...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunityDates : Base<EventOpportunityDatesModel>
  {
    protected internal EventOpportunityDates(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunityDatesModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventOpportunityDatesModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityDates options = null)
    {
    ...
    public EventOpportunityDatesModel Update(EventOpportunityDatesModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityDates options = null)
    {
    ...
    public EventOpportunityDatesModel Add(EventOpportunityDatesModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityDates options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityDates options = null)
    {
