...
namespace Ungerboeck.Api.Sdk.Endpoints
{
  ...
  /// </summary>
  public class EventOpportunityContacts : Base<EventOpportunityContactsModel>
  {
    protected internal EventOpportunityContacts(ApiClient api) : base(api) { }
    ...
    public new Ungerboeck.Api.Models.Search.SearchResponse<EventOpportunityContactsModel> Search(string orgCode, string searchOData, Search options = null)
    {
    ...
    public EventOpportunityContactsModel Get(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityContacts options = null)
    {
    ...
    public EventOpportunityContactsModel Update(EventOpportunityContactsModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityContacts options = null)
    {
    ...
    public EventOpportunityContactsModel Add(EventOpportunityContactsModel model, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityContacts options = null)
    {
    ...
    public HttpResponseMessage Delete(int id, Ungerboeck.Api.Models.Options.Subjects.EventOpportunityContacts options = null)
    {
