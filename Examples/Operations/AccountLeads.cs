...
namespace Examples.Operations
{
  public class AccountLeads : Base
  {
    ...
    /// <param name="eventSales">designation of Account Lead</param>
    /// <returns></returns>
    public AccountLeadsModel Add(string orgCode, string contactFirstName, string contactLastName, string eventSales)
    {
