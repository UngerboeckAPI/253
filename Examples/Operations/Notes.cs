...
namespace Examples.Operations
{
  public class Notes : Base
  {
    ...
    public NotesModel AddEventOpportunityNote(string orgCode, string title, string text, int eventOpportunitySeq)
    {
      var note = new NotesModel
      {
        OrganizationCode = orgCode,
        Type = USISDKConstants.NoteType.EventOpportunityNote,
        Title = title,
        Text = text,
        EventOpportunity = eventOpportunitySeq
      };

      return apiClient.Endpoints.Notes.Add(note);
    }
