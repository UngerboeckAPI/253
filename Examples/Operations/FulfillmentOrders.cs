...
namespace Examples.Operations
{
  public class FulfillmentOrders : Base
  {
    ...
    public Ungerboeck.Api.Models.Search.SearchResponse<FulfillmentOrdersModel> SearchForUserFields(string orgCode)
    {
      ...
      //This is searching for Order user fields of Issue Class = C (event sales), Issue Type code = RY, organization code = 10, and User Text 01 (TXT_01).  It will return orders where the value is 7
      return apiClient.Endpoints.FulfillmentOrders.Search(orgCode, "C|RY|10|UserText01 eq '7'");
    }
