...
namespace Examples.Operations
{
  public class Spaces : Base
  {
    ...
    /// <summary>
    /// A basic edit example with space classes
    /// </summary>  
    public SpacesModel EditSpaceClasses(string orgCode, string code, string spaceClasses)
    {
      SpacesModel space = apiClient.Endpoints.Spaces.Get(orgCode, code);
      space.SpaceClasses = spaceClasses;

      return apiClient.Endpoints.Spaces.Update(space);
    }
    ...
    /// <summary>
    /// A basic add example with space classes
    /// </summary>  
    public SpacesModel AddWithSpaceClasses(string orgCode, string code, string spaceClasses)
    {
      SpacesModel space = new SpacesModel()
      {
        Organization = orgCode,
        Code = code,
        SpaceDescription = "Hall-A",
        SpaceClasses = spaceClasses
      };

      return apiClient.Endpoints.Spaces.Add(space);
    }
  }
}
