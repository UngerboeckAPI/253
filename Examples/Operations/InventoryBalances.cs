...
namespace Examples.Operations
{
  public class InventoryBalances : Base
  {
    ...
    /// </summary>   
    public SearchResponse<InventoryBalancesModel> Search(string orgCode, int searchValue)
    {
      return apiClient.Endpoints.InventoryBalances.Search(orgCode, $"FiscalYear eq {searchValue}");
    }
  }
}
