...
namespace Examples.Operations
{
  public class Activities : Base
  {
    ...
    public ActivitiesModel AddEventOpportunityActivity(string orgCode, Int32 eventOpportunitySequence, string 
      text, string accountCode, string recipient, string  type, string entryDesignation)
    {
      var myActivity = new ActivitiesModel
      {
        OrganizationCode = orgCode,
        Text = text,
        EventOpportunity = eventOpportunitySequence,
        Type = type,
    ...
    public ActivitiesModel AddMeetingActivity(string orgCode, int meetingSequence, string newActivityText, string accountCode)
    {
      var myActivity = new ActivitiesModel
      {
        OrganizationCode = orgCode,
        Text = newActivityText,
        EventOpportunity = meetingSequence,
        Account = accountCode      
      };
    ...
    public ActivitiesModel AddEventOpportunityActivity(string orgCode, int meetingSequence, string newActivityText, string accountCode)
    {
      var myActivity = new ActivitiesModel
      {
        OrganizationCode = orgCode,
