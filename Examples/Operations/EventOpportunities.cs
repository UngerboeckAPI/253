...
namespace Examples.Operations
{
  public class EventOpportunities : Base
  {
    ...
    /// <summary>
    /// Updates an existing event opportunity's description.
    /// </summary>
    ...
    /// <summary>
    /// Updates an existing event opportunity using a whole model.
    /// </summary>
    /// <param name="strOrgCode"></param>
    /// <param name="intMeetingSeq"></param>
    /// <returns>Updated EventOpportunitiesModel</returns>
    public EventOpportunitiesModel Edit(EventOpportunitiesModel meetingModel)
    {
      return apiClient.Endpoints.EventOpportunities.Update(meetingModel);
    }
